...
public class DefaultMQProducerImpl implements MQProducerInner {
        ...
        if (brokerAddr != null) {
            ...
            try {
                if (!(msg instanceof MessageBatch)) { //for MessageBatch,ID has been set in the generating process
                    MessageClientIDSetter.setUniqID(msg); // 批量消息
                }
    ...
    public void endTransaction(final SendResult sendResult, final LocalTransactionState localTransactionState, final Throwable localException)
